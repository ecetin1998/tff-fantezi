...
export default async function Availability(){
  ...
  return <><div className="section-title"><div><span className="eyebrow">SAKATLIK & CEZA</span><h1>MH{run?.gameweek||'—'} Durum Takibi</h1></div><span className="muted">{rows.length} kayıt</span></div>
