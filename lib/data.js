...
function eloFixture(homeRating,awayRating){
  ...
  const level=p=>p>=.60?'easy':p<=.40?'hard':'medium'
  return {homeExpected,awayExpected:1-homeExpected,homeLevel:level(homeExpected),awayLevel:level(1-homeExpected)}
}
  ...
  return {
    ...
    matches:(matches||[]).map(m=>{
      ...
      return {
        ...
        home_fixture_level:fixture.homeLevel,
        away_fixture_level:fixture.awayLevel,
