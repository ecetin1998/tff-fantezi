...
export const TEAM_IDS = {
  'Trabzonspor':1,'Erzurumspor':2,'Kasımpaşa':3,'Kocaelispor':4,'Amed':5,'Fenerbahçe':6,
  'Konyaspor':7,'Çorum FK':8,'Beşiktaş':9,'Göztepe':10,'Gençlerbirliği':11,'Rizespor':12,
  'Başakşehir':13,'Alanyaspor':14,'Samsunspor':15,'Eyüpspor':16,'Galatasaray':17,'Gaziantep':18,
}
export function teamHref(team,id){
  const resolved=Number(id)||TEAM_IDS[team]
  return resolved ? '/teams/'+resolved : '/teams'
}
